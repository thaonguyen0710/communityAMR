...
# Make sure GEMINI_API_KEY matches the variable name in your screen.env file!
...
# Specify the DeepSeek model to use (e.g., gemini-1.5-pro or gemini-2.5-pro)
GEMINI_MODEL_NAME = os.getenv("GEMINI_MODEL_NAME", "gemini-1.5-pro")

def get_api_key():
    """Returns the loaded API key."""
    if not API_KEY:
        print("Warning: GEMINI_API_KEY not found. Please set it in the .env file.")
    return API_KEY
